...
class Vehiculo {
    ...
    public function crear() {
        ...
        $query = "INSERT INTO " . $this->table_name . " 
                SET interno=:interno, anio=:anio, dominio=:dominio, modelo=:modelo,
                    ...
                    hab_estado=:hab_estado, seguro_vencimiento=:seguro_vencimiento,
                    seguro_estado=:seguro_estado, tipo=:tipo, sede_id=:sede_id, activo=:activo";
        ...
        $this->seguro_estado = $this->seguro_estado ? htmlspecialchars(strip_tags($this->seguro_estado)) : '';
        ...
        $stmt->bindParam(":seguro_estado", $this->seguro_estado);
    ...
    public function leerUno() {
        ...
        if($row) {
            ...
            $this->seguro_estado = $row['seguro_estado'];
            $this->tipo = $row['tipo'];
            $this->sede_id = $row['sede_id'];
    ...
    public function actualizar() {
        $query = "UPDATE " . $this->table_name . " 
                SET anio=:anio, dominio=:dominio, modelo=:modelo, eq_incorporado=:eq_incorporado, 
                    ...
                    seguro_vencimiento=:seguro_vencimiento, seguro_estado=:seguro_estado, 
                    tipo=:tipo, sede_id=:sede_id, activo=:activo
